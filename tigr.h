...
#define TIGR_KEEP 1          // window's bitmap is a fixed size and don´t keep the specified scale (default scale 1)
#define TIGR_AUTO 2          // window's bitmap is scaled with the window
#define TIGR_2X 4            // always enforce (at least) 2X pixel scale
#define TIGR_3X 8            // always enforce (at least) 3X pixel scale
#define TIGR_4X 16           // always enforce (at least) 4X pixel scale
#define TIGR_RETINA 32       // enable retina support on OS X
#define TIGR_NOCURSOR 64     // hide cursor
#define TIGR_FULLSCREEN 128  // start in full-screen mode
